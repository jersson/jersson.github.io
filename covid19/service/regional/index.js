exports.covidRegionalTrends = (req, res) => {
    let regionalTrends = {
        ...
        datasets: [{
            ...
            // data: [8,8,12,12,13,15,22], Lamb
            // data: [12,12,13,15,22,22,30],Lamb
            // data: [12,13,15,22,22,30,34], Lamb
            // data: [13,15,22,22,30,34,37], Lamb
            data: [10,13,15,19,32,34,44], 
            label: 'La Libertad',
            borderColor: '#e8c3b9',
            fill: false
        }
